...
const MENU_ITEMS = [
	...
	{ title: 'lambanog', href: '/lambanog' },
	{ title: 'cocktails', href: '/cocktails' },
	{ title: 'house of lakan', href: '/house-of-lakan' },
...
const PRODUCTS: Array<Products> = [
	{
		...
		color: 'gold',
		description:
			'Distilled in the traditional 90 proof, Lakan Gold has subtle fruit and vanilla notes combined with a smooth finish, perfect for celebrations and milestones.',
	},
	{
		name: 'Lakan Silver',
		...
		color: 'silver',
		description:
			'Lakan Silver is distilled four to five times in a similar process to vodka, giving it a fresh and clean taste with notes of fresh calamansi and coconut meat.',
	},
	{
		name: 'Lakan Bronze',
		...
		color: 'bronze',
		description:
			'Smooth with a hint of sweetness, Lakan Bronze is an accessible spirit that’s the perfect pair to most fruits, sodas, and tonics. ',
	},
];
