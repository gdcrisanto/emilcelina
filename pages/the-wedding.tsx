...
export default function TheWedding() {
  ...
  return (
    <Layout>
      ...
      <div
        className={`flex flex-row py-4 w-full text-base lg:text-2xl z-30 text-[#46542f] px-4 justify-around sticky transition-all ease-in-out duration-300 ${
          !isScrollUp ? 'top-0' : 'top-[72px] lg:top-[127px]'
        } bg-[#FCF4EA]`}
      >
          ...
          return (
            <a
              className={`w-1/4 text-center cursor-pointer ${
                isAnchor === anchor.id ? 'border-b border-[#46542f]' : ''
              }`}
              onClick={() => {
      ...
      <ColoredBgWrapper bgColor="white">
        <div id="invitation" />
        <div className="flex flex-col w-full max-w-[1920px] mx-auto gap-x-20 px-60 lg:px-80 py-10 pt-20 lg:py-20 fade-up gap-4">
      ...
      <ColoredBgWrapper bgColor="nata">
        <div id="schedule" />
        <div className="flex flex-col lg:flex-row w-full max-w-[1920px] mx-auto gap-x-20 px-10 lg:px-32 py-14">
      ...
      <ColoredBgWrapper bgColor="white">
        <div id="attire" />
        <div className="flex flex-col-reverse lg:flex-row w-full max-w-[1920px] mx-auto gap-x-20 px-10 lg:px-32 py-10 pt-20 lg:py-20 fade-up">
          <div className="flex flex-col w-full lg:w-[55%] mb-20 lg:mb-0 justify-center ">
            ...
            <div className="flex flex-row w-full justify-around my-6">
              {ATTIRE_FOR_GUESTS.colors.map((color, i) => {
                const colors = ['bg-[#F0E8DB]', 'bg-[#E2D4C5]', 'bg-[#D8C9BA]'];
