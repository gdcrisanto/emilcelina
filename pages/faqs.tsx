            ...
            return (
              ...
              >
                <Collapsible
                  ...
                  trigger={
                    <div className="font-playfair items-center flex-shrink-0 flex flex-row w-full justify-between py-4 cursor-pointer font-playfair text-2xl text-left fade-up text-[#573319] font-playfair lg:text-5xl leading-[100%] font-medium">
                      {faq.question}
                      <ChevronLeft
                        className={`items-center flex-shrink-0 transition-all ease-in-out duration-300 ${
                          isOpenFAQ[i] ? `` : `-rotate-180`
                        }`}
                      />
                    </div>
                  }
