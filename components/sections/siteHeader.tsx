...
const SiteHeader = ({ textBlack }: SiteHeaderProps) => {
	...
	return (
		<div
			...
			className={
				`z-50 h-[72px] lg:h-[127px] w-full mx-auto fixed bg-[#FCF4EA] transition-all ease-in-out duration-300 lg:duration-200 ${!isScrollUp ? 'top-[-72px] lg:top-[-172px]' : 'top-0'} ${isOpen ? 'site-header-scroll' : ''}`
			}
		>
